...
tau=250000     #steps of the simulation (tau in westpa) (int)
n_chains=100   #number of chains of the system (int)
L=300.         #length of the box
rc=17.         #minimum radius to consider a chain is inside a cluster
...
python cluster.py --seq $seq --rc $rc --L $L --n_chains $n_chains
